...
//CustomKeywords.'com.appEmpresarial.helperCommonAction.permissionCheckOfAccounts'(GlobalVariable.ID+':id/txtaccType', GlobalVariable.ID+':id/txtBalancedisponible', GlobalVariable.ID+':id/lblTransitos' 'txtLoanAlias', GlobalVariable.ID+':id/txtAccType', 'RD', 'Object Repository/Pagos/android.widget.TextView - Prstamos Dashboard', 'Object Repository/Pagos/android.widget.TextView - Detalle Prstamo', 'Object Repository/Pagos/android.widget.LinearLayout - Pagar', company_one)
