...
//CustomKeywords.'com.appEmpresarial.helperCommonAction.permissionCheckOfAccounts'(GlobalVariable.ID+':id/txtaccType', GlobalVariable.ID+':id/txtBalancedisponibles', GlobalVariable.ID+':id/txtDisponible', GlobalVariable.ID+':id/txtAccType', 'RD', 'Object Repository/Pagos/Tarjeta/Cuentas Dashboard', 'Object Repository/Pagos/Tarjeta/Cuenta Detail Heading', 'Object Repository/Pagos/Tarjeta/Pagar in Cuenta', company_one)
