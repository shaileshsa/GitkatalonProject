...
//CustomKeywords.'com.appEmpresarial.helperCommonAction.permissionCheckOfAccounts'(GlobalVariable.ID+':id/txtaccType', GlobalVariable.ID+':id/txtBalancedisponibles', GlobalVariable.ID+':id/txtDisponible', GlobalVariable.ID+':id/txtAccType', 'USD', 'Object Repository/Pagos/Tarjeta/Cuentas Dashboard', 'Object Repository/Pagos/Tarjeta/Cuenta Detail Heading', 'Object Repository/Pagos/Tarjeta/Pagar in Cuenta', company_one)
CustomKeywords.'com.appEmpresarial.helperCommonAction.permissionCheckOfAccounts'(GlobalVariable.ID+':id/txtaccType', GlobalVariable.ID+':id/txtBalancedisponibles', GlobalVariable.ID+':id/txtAccType', GlobalVariable.ID+':id/txtAccType', desde, 'Object Repository/Pagos/Tarjeta/Cuentas Dashboard', 'Object Repository/Pagos/Tarjeta/Cuenta Detail Heading', 'Object Repository/Pagos/Tarjeta/Pagar in Cuenta', company_one, 'US', GlobalVariable.ID+':id/txtDisponible')

//select tarjeta
CustomKeywords.'com.appEmpresarial.helperCommonAction.tapWithCheck'('Object Repository/Pagos/Tarjeta/Tarjeta in Cuenta', 'Object Repository/Pagos/Tarjeta/Tarjeta in Cuenta')
