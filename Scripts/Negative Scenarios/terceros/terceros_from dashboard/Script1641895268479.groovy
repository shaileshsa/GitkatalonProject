...
//CustomKeywords.'com.appEmpresarial.helperCommonAction.permissionCheckOfAccounts'(GlobalVariable.ID+':id/txtaccType', GlobalVariable.ID+':id/txtBalancedisponibles', GlobalVariable.ID+':id/txtAccType', GlobalVariable.ID+':id/txtAccType', desde, 'Object Repository/Transferencias/Terceros/Cuentas Dashboard', 'Object Repository/Transferencias/Terceros/Cuenta Detail Heading', 'Object Repository/Transferencias/Terceros/Transfer in Cuenta', company, 'RD', GlobalVariable.ID+':id/txtDisponible')
CustomKeywords.'com.appEmpresarial.helperCommonAction.permissionCheckOfAccounts'(GlobalVariable.ID+':id/txtaccType', GlobalVariable.ID+':id/txtBalancedisponibles', GlobalVariable.ID+':id/txtAccType', GlobalVariable.ID+':id/txtAccType', desde, 'Object Repository/Transferencias/Terceros/Cuentas Dashboard', 'Object Repository/Transferencias/Terceros/Cuenta Detail Heading', 'Object Repository/Transferencias/Terceros/Transfer in Cuenta', company, 'RD', GlobalVariable.ID+':id/txtDisponible')

//tap tercero
CustomKeywords.'com.appEmpresarial.NegativeTestsKeyword.clickAfterRegistration'('Object Repository/Transferencias/Terceros/Tercero in Cuenta', 'Object Repository/Transferencias/Terceros/Tercero in Cuenta')
