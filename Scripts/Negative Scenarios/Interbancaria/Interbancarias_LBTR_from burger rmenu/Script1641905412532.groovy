...
//tap desde
CustomKeywords.'com.appEmpresarial.NegativeTestsKeyword.clickAfterRegistration'('Object Repository/Transferencias/InterBank/Desde Interbank', 'Object Repository/Transferencias/InterBank/Desde Interbank')
...
//tap pago al Instante
CustomKeywords.'com.appEmpresarial.NegativeTestsKeyword.clickAfterRegistration'('Object Repository/Transferencias/InterBank/LBTR Interbank Button', 'Object Repository/Transferencias/InterBank/LBTR Interbank Button')
...
//data check
//CustomKeywords.'com.appEmpresarial.helperCommonAction.dataCheckForinterbank'(GlobalVariable.ID+':id/txtbeneficiry', GlobalVariable.ID+':id/txtdesdeCuenta', GlobalVariable.ID+':id/txttipodetransaction', GlobalVariable.ID+':id/txtbalancedis', GlobalVariable.ID+':id/txtmontocomition', GlobalVariable.ID+':id/txttotaldebitar')
