...
//CustomKeywords.'com.appEmpresarial.helperCommonAction.permissionCheckOfAccounts'(GlobalVariable.ID+':id/txtaccType', GlobalVariable.ID+':id/txtBalancedisponible', GlobalVariable.ID+':id/txtDisponible', GlobalVariable.ID+':id/txtAccType', 'RD', 'Object Repository/Pagos/Tarjeta/Tarjeta Dashboard', 'Object Repository/Pagos/Tarjeta/Tarjeta Detail Heading', 'Object Repository/Pagos/Tarjeta/Pagar in Tarjeta', company_one)
...
CustomKeywords.'com.appEmpresarial.NegativeTestsKeyword.clickAfterRegistration'('Object Repository/Pagos/Tarjeta/Select Other Amount', 'Object Repository/Pagos/Tarjeta/Select Other Amount')
