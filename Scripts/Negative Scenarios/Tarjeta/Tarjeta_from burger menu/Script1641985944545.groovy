...
//tap burger menu
CustomKeywords.'com.appEmpresarial.NegativeTestsKeyword.clickAfterRegistration'('Object Repository/Common Objects/Burger Menu/Burger Menu', 'Object Repository/Common Objects/Burger Menu/Burger Menu')

//tap option Pagos
CustomKeywords.'com.appEmpresarial.NegativeTestsKeyword.clickAfterRegistration'('Object Repository/Pagos/Tarjeta/Pagos In Burger Menu', 'Object Repository/Pagos/Tarjeta/Pagos In Burger Menu')

//tap Sub Option Tarjeta
CustomKeywords.'com.appEmpresarial.NegativeTestsKeyword.clickAfterRegistration'('Object Repository/Pagos/Tarjeta/Tarjetas in Burger Menu', 'Object Repository/Pagos/Tarjeta/Tarjetas in Burger Menu')
...
//tap desde
CustomKeywords.'com.appEmpresarial.NegativeTestsKeyword.clickAfterRegistration'('Object Repository/Pagos/Tarjeta/Pago a Tarjeta Heading', 'Object Repository/Pagos/Tarjeta/Desde')
...
//tap hasta
CustomKeywords.'com.appEmpresarial.NegativeTestsKeyword.clickAfterRegistration'('Object Repository/Pagos/Tarjeta/Pago a Tarjeta Heading', 'Object Repository/Pagos/Tarjeta/Hasta')
...
//CustomKeywords.'com.appEmpresarial.helperCommonAction.tapWithCheck'('Object Repository/Pagos/Tarjeta/Select Other Amount', 'Object Repository/Pagos/Tarjeta/Select Other Amount')
...
if(Mobile.waitForElementPresent(findTestObject('Object Repository/Pagos/Tarjeta/Select Other Amount'), GlobalVariable.timeOut_5_Sec, FailureHandling.OPTIONAL))
{
	  ...
	  if('false'.equals(Mobile.getAttribute(findTestObject('Object Repository/Common Objects/Continuar Button/continue button 13'), 'clickable', 2))) 
	     {		      
	...
	Mobile.tap(findTestObject('Object Repository/Pagos/Tarjeta/RD New'), GlobalVariable.timeOut_5_Sec, FailureHandling.OPTIONAL)
...
//CustomKeywords.'com.appEmpresarial.helperCommonAction.checkElementPresent'(GlobalVariable.ID+':id/btnContinuar', 'Continuar', GlobalVariable.ID+':id/txtDesdeCuenta', GlobalVariable.ID+':id/txtBeneficiario')
