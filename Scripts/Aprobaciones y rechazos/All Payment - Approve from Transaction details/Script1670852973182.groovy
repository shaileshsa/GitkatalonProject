...
elements = driver.findElementsById(GlobalVariable.ID+':id/radioSelect')
...
//tap approve all
CustomKeywords.'com.appEmpresarial.helperCommonAction.tapWithCheck'('Object Repository/Aprobaciones y rechazos/Approve All Button', 'Object Repository/Aprobaciones y rechazos/Approve All Button')

if (Mobile.verifyElementVisible(findTestObject('Object Repository/Aprobaciones y rechazos/Approve All Transaction (msg)'), GlobalVariable.timeOut_2_Sec)) {
	CustomKeywords.'com.appEmpresarial.helperCommonAction.tapWithCheck'('Object Repository/Aprobaciones y rechazos/Approve All Transaction (msg)', 'Object Repository/Aprobaciones y rechazos/Si button')
}
...
//check error
CustomKeywords.'com.appEmpresarial.helperCommonAction.checkError'('Object Repository/Aprobaciones y rechazos/Transaction Approved for Multiple Transaction (msg)')
