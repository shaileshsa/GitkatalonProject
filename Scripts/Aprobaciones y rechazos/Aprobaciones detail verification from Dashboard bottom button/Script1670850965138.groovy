...
if(Mobile.verifyElementVisible(findTestObject('Object Repository/Aprobaciones y rechazos/Approve All Transaction (msg)'), GlobalVariable.timeOut_2_Sec, FailureHandling.OPTIONAL)==true) {
